...
" Last Change:	2004 Jun 1  - This is butt ugly! Fixing stuff
"		2003 May 11
...
syn region   smlEncl transparent matchgroup=smlKeyChar start="(" matchgroup=smlKeyChar end=")" contains=ALLBUT,@smlContained,smlParenErr
syn region   smlEncl transparent matchgroup=smlKeyChar start="{" matchgroup=smlKeyChar end="}"  contains=ALLBUT,@smlContained,smlBraceErr
syn region   smlEncl transparent matchgroup=smlKeyChar start="\[" matchgroup=smlKeyChar end="\]" contains=ALLBUT,@smlContained,smlBrackErr
syn region   smlEncl transparent matchgroup=smlKeyChar start="#\[" matchgroup=smlKeyChar end="\]" contains=ALLBUT,@smlContained,smlBrackErr
...
syn region   smlEnd matchgroup=smlKeyword start="\<letrec\>" matchgroup=smlKeyword end="\<end\>" contains=ALLBUT,@smlContained,smlEndErr

syn region   smlEnd matchgroup=smlKeyword start="\<cletrec\>" matchgroup=smlKeyword end="\<end\>" contains=ALLBUT,@smlContained,smlEndErr
...
syn keyword  smlKeyword  else eqtype
syn keyword  smlKeyword  fn fun handle
syn keyword  smlKeyword  in infix infixl infixr
syn keyword  smlKeyword  match nonfix of orelse
syn keyword  smlKeyword  raise handle
syn keyword  smlKeyword  val where while with

syn keyword  smlTypeDef  datatype type withtype exception
...
if version >= 508 || !exists("did_sml_syntax_inits")
  ...
  HiLink smlConstructor  Identifier

  HiLink smlModPreRHS	 Keyword
  HiLink smlMPRestr2	 Keyword
  HiLink smlKeyword	 Keyword
  HiLink smlFunDef	 Special "Keyword
  HiLink smlRefAssign	 Special "Keyword
  HiLink smlKeyChar	 Special "Keyword
  HiLink smlAnyVar	 Normal	"Keyword
  HiLink smlTopStop	 Special "Keyword
  HiLink smlOperator	 Special "Keyword

  HiLink smlTypeVar	 Identifier
  ...
  HiLink smlTypeDef	 TypeDef
  HiLink smlType	 Type
  HiLink smlTodo	 Todo
  HiLink smlEncl	 Special
